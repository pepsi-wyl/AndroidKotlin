...
import site.ylan.sunnyweather.databinding.ActivityWeatherBinding
import site.ylan.sunnyweather.date.model.Weather
import site.ylan.sunnyweather.date.model.getSky
...
class WeatherActivity : AppCompatActivity() {
    ...
    private fun showWeatherInfo(weather: Weather) {
        ...
        for (i in 0 until days) {
            ...
            dateInfo.text = OffsetDateTime.parse(skycon.date).format(DateTimeFormatter.ofPattern("yyyy-MM-dd"))
